#ifndef HAMMURABI_ROUND_INPUT_INL
#define HAMMURABI_ROUND_INPUT_INL

namespace hammurabi {

template<class T>
constexpr RoundInputResult RoundInput::New(const hammurabi::AreaToBuy area_to_buy,
                                           const hammurabi::AreaToSell area_to_sell,
                                           const hammurabi::GrainToFeed grain_to_feed,
                                           const hammurabi::AreaToPlant area_to_plant,
...
constexpr RoundInput::RoundInput(const hammurabi::AreaToBuy area_to_buy,
                                 const hammurabi::AreaToSell area_to_sell,
                                 const hammurabi::GrainToFeed grain_to_feed,
                                 const hammurabi::AreaToPlant area_to_plant) noexcept
...
#endif //HAMMURABI_ROUND_INPUT_INL
